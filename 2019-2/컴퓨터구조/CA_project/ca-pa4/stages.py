...
class Control(object):
    ...
    def gen(self, inst):
        ...
        # FD_ dependency with EX_ : when FD stage's inst is either branch or R-type or store/load
        ...
        # FD_ dependency with MW_ : when FD stage's inst is either branch or R-type or store/load
